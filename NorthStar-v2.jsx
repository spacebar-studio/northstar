        ...
        <div style={{padding:"16px 28px"}}>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:12}}>
            <div style={{display:"flex",gap:6}}>
              ...
              <a href="https://drive.google.com/file/d/1k12XFbwg73h7kuRxVaK6QqyeBSqP5SWE/view?usp=sharing" target="_blank" rel="noopener noreferrer" style={{padding:"5px 12px",borderRadius:4,background:C.s2,color:C.t1,fontSize:10,fontWeight:600,textDecoration:"none",fontFamily:FT}}>Resume</a>
